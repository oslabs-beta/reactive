...
const Dendrogram = ({ data }) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        function update(source) {
            ...
            const truncatedName = (d) => fileName(d).length > NODE_CONFIG.textTruncateLength
        ...
        svg
            .transition()
            .duration(2000)
            .call(zoom.transform, d3.zoomIdentity.translate(width / 2, 50).scale(0.8), d3.zoomTransform(svg.node()).invert([width / 2, height / 2]));
        // Cleanup function
        return () => {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("button", { onClick: () => setDarkMode((prev) => !prev), style: {
                position: "absolute",
                top: 10,
                right: 10,
                zIndex: 1,
        ...
        react_1.default.createElement("svg", { ref: svgRef, width: "100vw", height: "100vh" },
