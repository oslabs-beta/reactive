...
### Getting Started
- **First Time Contributors**: Check out our [First-Time Contributors Guide](https://github.com/oslabs-beta/reactive/blob/HEAD/CONTRIBUTING.md#new-to-open-source)
- **Ready to Code**: See our [Contribution Guidelines](https://github.com/oslabs-beta/reactive/blob/HEAD/CONTRIBUTING.md#experienced-contributor-guide)
...
For detailed setup instructions, coding guidelines, and best practices, see our [CONTRIBUTING.md](https://github.com/oslabs-beta/reactive/blob/HEAD/CONTRIBUTING.md).
...
For detailed information about the npm scripts available in the project, their purposes, and when to use them during development, please refer to the [Development Scripts Guide](https://github.com/oslabs-beta/reactive/blob/HEAD/DEVELOPMENT_SCRIPTS.md).
...
- [Contributing Guidelines](https://github.com/oslabs-beta/reactive/blob/HEAD/CONTRIBUTING.md)
- [VS Code Development Guide](https://github.com/oslabs-beta/reactive/blob/HEAD/VS_CODE_DEVELOPMENT.md)
- [Changelog](https://github.com/oslabs-beta/reactive/blob/HEAD/CHANGELOG.md)
- [License](https://github.com/oslabs-beta/reactive/blob/HEAD/LICENSE.md)
